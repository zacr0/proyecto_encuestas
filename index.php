<?php
    ...
    if ($_SESSION['nombre'] == '') {
        ...
        if (isset($_POST['buscar'])) {
            buscarEncuestas($_POST['busqueda']);
        } else {
            while($result = mysqli_fetch_object($req)){
                echo '<li class="list-group-item ">
                <a class="lead" href="encuesta.php?id=' . $result->id . '">' . $result->titulo . '</a>
                <a href="resultado.php?id=' . $result->id . '" class="pull-right">Ver Resultados <span class="glyphicon glyphicon-arrow-right"></span></a>
                </li>';
            }
        } 
        echo '</ul>
